...
A subagent that opens a PR runs **interrogate** and **unslop**, plus any additional review capability the current runtime mapping explicitly supports. It returns the URL and does not babysit. Return to the parent.
