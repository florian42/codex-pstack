...
delivery. `eval` and `session-pickup` have not been mapped onto the task-history
row above yet. Those five are the only unsupported routes. The Claude Code distribution
