...
- Read operations against any `SKILL.md` discovered through the runtime's skill-authoring mapping.
- Delegation prompts recorded by the runtime's delegation capability that name a skill path
