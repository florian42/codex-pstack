...
current runtime's delegation, monitoring, and model-role mappings. If fewer than
two independent reviewers can run, stop and report that adversarial review is
blocked; a parent-only review is not `/interrogate`.
