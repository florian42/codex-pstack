...
- [Attack the Premise](../../skills/principle-attack-the-premise/SKILL.md) questions a shared premise after repeated fixes fail the same gate.
...
- [Test Behavior Not Implementation](../../skills/principle-test-behavior-not-implementation/SKILL.md) asserts literal results observed through the user-facing path.
