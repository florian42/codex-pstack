...
**Verify, live.** Tests alone are not sufficient verification. A PR is verified only when its unit, live, and perf boxes are all checked. Ten lanes on the runtime mapping's live-driving model role at the PR head, per the boot recipe.
